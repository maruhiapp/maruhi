...
- 監査ログ UI、Web ダッシュボード(**信頼境界は ADR-0018 — 2026-08-18 裁定**: Web は鍵・平文を持たない管理画面。値・鍵操作は各人の CLI、画面は TUI → 値なし `maruhi ui` → 値ありは独立 ADR の段階導入。W0 は「誰がこの画面を見るか」から)
