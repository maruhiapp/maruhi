...
export const maruhiTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#FFFBF9, #241915)",
    "--color-background-body": "light-dark(#FFEDE7, #1B0D07)",
    "--color-background-card": "light-dark(#FFFBF9, #241915)",
    "--color-background-popover": "light-dark(#FFFBF9, #3A2E29)",
    "--color-background-muted": "light-dark(#2419150D, #24191580)",
    "--color-accent": "light-dark(#C1330B, #FF693C)",
    "--color-accent-muted":
    ...
    "--color-text-secondary": "light-dark(#56423C, #BDA69F)",
    "--color-text-disabled": "light-dark(#A28C85, #6E5A53)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#111111",
    "--color-on-accent": "light-dark(#FFFFFF, #241915)",
    ...
    "--color-icon-secondary": "light-dark(#56423C, #BDA69F)",
    "--color-icon-disabled": "light-dark(#A28C85, #6E5A53)",
    ...
    "--color-border": "light-dark(#2419151A, #FFEDE71A)",
    "--color-border-emphasized": "light-dark(#A28C85, #78645D)",
    "--color-skeleton": "light-dark(#BDA69F, #56423C)",
    ...
    "--color-track": "light-dark(#BDA69F, #56423C)",
  },
  localTokens: {
  ...
  __localTokenLineage: ["neutral", "maruhi"],
  components: {
    heading: {
      "level:1": {
