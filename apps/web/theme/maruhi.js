...
/**
 * maruhi theme — built by `bunx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { maruhiTheme } from './maruhi';
 *   import './maruhi.css';
 */
export const maruhiTheme = {
  name: "maruhi",
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#FFFBFA, #251817)",
    "--color-background-body": "light-dark(#FFEDEA, #1C0D09)",
    "--color-background-card": "light-dark(#FFFBFA, #251817)",
    "--color-background-popover": "light-dark(#FFFBFA, #3B2D2B)",
    "--color-background-muted": "light-dark(#2518170D, #25181780)",
    "--color-accent": "light-dark(#B22A2B, #FFB3A8)",
    "--color-accent-muted":
      "light-dark(color-mix(in srgb, var(--color-accent) 20%, transparent), color-mix(in srgb, var(--color-accent) 25%, transparent))",
    "--color-neutral": "light-dark(#2518171A, #F1DEDC33)",
    ...
    "--color-text-primary": "light-dark(#251817, #F1DEDC)",
    "--color-text-secondary": "light-dark(#57423F, #BFA6A2)",
    "--color-text-disabled": "light-dark(#A38B88, #6F5956)",
    ...
    "--color-icon-primary": "light-dark(#251817, #F1DEDC)",
    "--color-icon-secondary": "light-dark(#57423F, #BFA6A2)",
    "--color-icon-disabled": "light-dark(#A38B88, #6F5956)",
    ...
    "--color-border": "light-dark(#2518171A, #FFEDEA1A)",
    "--color-border-emphasized": "light-dark(#BFA6A2, #57423F)",
    "--color-skeleton": "light-dark(#BFA6A2, #57423F)",
    ...
    "--color-background-inverted": "light-dark(#251817, #FFFBFA)",
    "--color-track": "light-dark(#BFA6A2, #57423F)",
  },
};
