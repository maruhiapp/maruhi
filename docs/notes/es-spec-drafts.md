# ES 仕様改訂ドラフト — 環境スコープの role + PF1 四眼(2026-09-14 起草・同日所有者承認・K1 反映済み)

**位置づけ**: ES / PF1 フェーズ 1(設計セッション)の成果物。設計の全体像・裁定の反復記録・実装分割・承認依頼項目は docs/notes/es-design.md。本ファイルは正本 3 文書(CRYPTO_SPEC / AUTH_SPEC / AUDIT_SPEC)へ反映した**改訂本文の起草時の写し**である。**2026-09-14 に所有者が承認項目 1〜24 を承認し(項目 5 は承認後の訂正あり — 設計録冒頭)、同日 K1 として正本へ反映済み**(CRYPTO_SPEC 0.11-draft §3 / §6.2 / §6.3 / §6.4 / §6.5 / §7 / §11 / §13 / §14.2、AUTH_SPEC 0.23-draft §6 / §9-2 / §11-1 / §12-3 / §12-4 / §12-6 / §12-7 / §12-8 / §14-1 / §15、AUDIT_SPEC 1.8-draft §3.3 / §3.4 / §4.1 / §6)。以後の正は各正本であり、本ファイルは経緯の記録として残す(差異が生じた場合は正本が勝つ)。K1 で正本に書く段階で生じた裁定(原則 1 / 原則 2 の置き場)は設計録の「K1 追記」に記録した。
