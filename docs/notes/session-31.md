...
- M1-A6(§7 裁定 2 のはしご — 2-F / 2-E / 2-D、第 5 次で 2-H を追加 —
  docs/notes/session-32.md §4-2 — から所有者が選ぶ)
- M1-B1
...
**第 5 次(2026-08-19 — 本ノートの追記後)**: 案 2-H(専用アンカー op の
複合原子同梱 — 2-F の強度を re-genesis なしで)の追加と推奨の差し替えは
docs/notes/session-32.md §4-2 を参照。はしごは 2-F / **2-H** / 2-E / 2-D になった。
