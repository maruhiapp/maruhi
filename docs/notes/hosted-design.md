...
| **招待制ベータ** | サインアップ招待コード(2-2) | 無料 | 不特定の外部開発者(HP1〜HP4) | §4 のゲート(S1〜S3 着地 × H1〜H5 完了 × **D1〜D5 完了〔デザインパス — 2026-09-03 所有者裁定で追加。ROADMAP.md〕** × public 化) |
...
- 依存: H1・H2 は互いに独立で並走可。H3・H4 も独立。H5 は H1〜H4 + S1〜S3 の完了を待つ。**D 系列(デザインパス — ROADMAP.md D1〜D5、2026-09-03 追加)は H6 のゲート**で、H4 の法務ページ・H6 の web 静的面の見た目の受け皿でもあるため D1 / D2 を先行させる。D2 は §7 L1(提供ドメイン — 2026-09-03 に製品 = `my.maruhi.app`・apex = LP・docs = `maruhi.dev` と裁定済み)と一体
