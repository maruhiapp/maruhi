...
Version: 0.4-draft
Status: 所有者承認済み(§4.1 値の書き込み署名 / §4.2 メタデータステートメント / §5.2 DEK コミットメント / §6.2 の `create_environment` と環境ライフサイクル規則 / §6.3〜§6.4 の追補 / §14 保証と非保証は 2026-08-04 の PR #27 マージで承認。§6.2 のメンバー鍵の一意性は PR #22、§5.1 は PR #21 のマージで承認済み)
